            ...
            <div class="card">
                <div class="card-body">
                    <div class="brand-section">
                        ...
                        <small class="text-muted">Enter your new password below</small>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" value="{{ old('email', $request->email) }}" class="form-control @error('email') is-invalid @enderror" placeholder="you@example.com" required autofocus autocomplete="username">
                        ...
                        <button type="submit" class="btn btn-reset w-100 text-white">Reset Password</button>
                    </form>
                </div>
            </div>
        </div>
